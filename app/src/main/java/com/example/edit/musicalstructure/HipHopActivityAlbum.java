...
public class HipHopActivityAlbum extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int index = 1; index < 11; index++) {
            music.add(new Music("HipHop Author", "Sound" + index, "icon"));
        }
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent back = new Intent(HipHopActivityAlbum.this, MainActivity.class);
                // Start the activity
                startActivity(back);
            }
        });
