...
class RockActivityAlbum extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int index = 1; index < 11; index++) {
            music.add(new Music("Rock Author", "Sound" + index, "icon"));
        }
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent back = new Intent(RockActivityAlbum.this, MainActivity.class);
                // Start the activity
                startActivity(back);
            }
        });
