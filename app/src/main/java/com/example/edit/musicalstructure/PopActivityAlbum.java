...
/**
 * Created by Edit on 2018. 04. 02..
 */

public class PopActivityAlbum extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int index = 1; index < 11; index++) {
            music.add(new Music("Pop Author", "Sound" + index, "icon"));
        }
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent back = new Intent(PopActivityAlbum.this, MainActivity.class);
                // Start the activity
                startActivity(back);
            }
        });
